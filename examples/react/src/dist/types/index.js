...
var StatePilot = (function () {
  ...
  StatePilot.prototype.createStore = function (
    storeName,
    initialState,
    useHistory
  ) {
    if (useHistory === void 0) {
      useHistory = false;
    }
  ...
  StatePilot.prototype.createStoreState = function (
    storeName,
    state,
    actionName,
    subStoreKey
  ...
  StatePilot.prototype.createStoreAction = function (
    name,
    store,
    subStoreKey,
    fn,
          ...
          return __generator(this, function (_c) {
            switch (_c.label) {
              ...
              case 1:
                ...
                return [
                  2,
                  this.createStoreState(store, nextState, name, subStoreKey)
                ];
            }
          });
        });
  ...
  StatePilot.prototype.getStoreStateHistory = function (
    storeName,
    startIndex,
    lastIndex
  ) {
  ...
  StatePilot.prototype.subscribe = function (store, callbackFn) {
    ...
    return function () {
      return _this.unsubscribe(store, subId);
    };
  };
  StatePilot.prototype.unsubscribe = function (store, subId) {
    ...
    return "unsubcribed from store "
      .concat(store, " with subscription id ")
      .concat(subId);
  };
  StatePilot.prototype.eventHandler = function (
    eventName,
    storeName,
    state,
    actionName,
    ...
    if (actionName && subStoreKey)
      this.publish(actionName, subStoreKey, {
        storeName: storeName,
        eventName: eventName,
        state: state
      });
  ...
  StatePilot.prototype.publish = function (store) {
    ...
    Object.values(subs).forEach(function (sub) {
      if (sub) sub.apply(void 0, __spreadArray([], __read(args), false));
    });
  };
  return StatePilot;
})();
